...
//	}
	...
	public static LDBNative loadLibrary(String path) throws Throwable {
		...
		try {
			System.loadLibrary("leveldb-intel");
			System.out.println("load INTEL build leveldb");
		} catch (Throwable e) {
			// TODO Auto-generated catch block
//			e.printStackTrace();	
			try {
				System.loadLibrary("leveldb");
				System.out.println("load GCC(X86) build leveldb");
			} catch (Throwable e1) {
				e1.printStackTrace();
				System.loadLibrary("leveldb-aarch");
				System.out.println("load GCC(AARCH) build leveldb");
			}
		}
