...
import org.brewchain.core.crypto.cwv.jce.ECKeyAgreement;
import org.brewchain.core.crypto.cwv.jce.ECKeyFactory;
import org.brewchain.core.crypto.cwv.jce.ECKeyPairGenerator;
import org.brewchain.core.crypto.cwv.jce.ECSignatureFactory;
...
import static org.brewchain.mcore.tools.bytes.BytesHelper.bigIntegerToBytes;
...
public class ECKey implements Serializable {
	 ...
	 * @return -
	 *
	 * @throws java.lang.IllegalStateException if the private key bytes are not
	 *                                         available.
	 */
	...
	public static class ECDSASignature {
		...
		public byte[] toByteArray() {
			...
			return org.brewchain.mcore.tools.bytes.BytesHelper.merge(
					org.brewchain.mcore.tools.bytes.BytesHelper.bigIntegerToBytes(this.r),
					org.brewchain.mcore.tools.bytes.BytesHelper.bigIntegerToBytes(this.s), new byte[] { fixedV });
		}
