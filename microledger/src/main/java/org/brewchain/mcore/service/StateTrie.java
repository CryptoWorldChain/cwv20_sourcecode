...
import org.brewchain.mcore.trie.StateTrieTree;
import org.brewchain.mcore.trie.StorageTrieNode;
...
//		dbReadSize.set(0);
	...
	public void put(byte[] key,ByteString bs, byte[] v) {
	...
	public void setRoot(byte[] keyhash) {
		...
		log.debug("load node from org.brewchain.mcore.crypto.hash:bb.size=" + (bb == null ? 0 : bb.length));
		if (bb != null) {
