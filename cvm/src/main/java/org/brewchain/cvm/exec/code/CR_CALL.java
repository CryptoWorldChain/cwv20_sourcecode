...
public class CR_CALL extends AbstractCodeRunner {
	...
	public int exec(Program program, Stack stack, StringBuffer hint) {
		...
		if (hint != null) {
			hint.append("addr: " + Hex.toHexString(codeAddress.getLast20Bytes()) + " gas: " + 0 + " inOff: "
		...
		if (contract != null) {
			...
			gas_cost = program.callToAddress(op, codeAddress, inDataOffs, inDataSize, outDataOffs, outDataSize);
		}
